[[releasenotes_start]]== Automation Controller Release Notes 4.3.0
...
The Automation Controller Release Notes provides release notes, known
issues, and related reference materials. This document has been updated
to include information for the latest release of .
...
self relnotes known_issues supported_locales
